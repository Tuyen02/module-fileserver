        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="use_elastic" id="use_elastic" value="1" {USE_ELASTIC_CHECKED} onchange="toggleElasticFields()" /> {LANG.enable_elastic}
                        </label>
                    </td>
                </tr>
                <tr>
                    <td>{LANG.elas_host}</td>
                    <td><input type="text" name="elas_host" id="elas_host" value="{CONFIG.elas_host}" class="form-control" /></td>
                </tr>
                <tr>
                    <td>{LANG.elas_port}</td>
                    <td><input type="text" name="elas_port" id="elas_port" value="{CONFIG.elas_port}" class="form-control" /></td>
                </tr>
                <tr>
                    <td>{LANG.elas_user}</td>
                    <td><input type="text" name="elas_user" id="elas_user" value="{CONFIG.elas_user}" class="form-control" /></td>
                </tr>
                <tr>
