...
$lang_module['deleted_at'] = 'Date created';
$lang_module['export_title'] = 'Export system data';
$lang_module['export_file'] = 'Export file';
$lang_module['import_file'] = 'Import file into the system';
$lang_module['choose_file'] = 'Choose file';
$lang_module['caution'] = 'Note that the uploaded file format must be an excel file with extensions such as: xlsx, xls. Before uploading the imported excel file to the system, you must send a list of folders/files in the excel file to Google Driev and ensure that the path of the folders/files is an internet path (with permission to share with everyone)';
$lang_module['demo_title'] = 'The sample file has the following format:';
...
$lang_module['checksess_false'] = 'Invalid information or incorrect session';
