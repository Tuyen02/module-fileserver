...
$lang_module['deleted_at'] = 'Ngày tạo';
$lang_module['export_title'] = 'Xuất dữ liệu hệ thống';
$lang_module['export_file'] = 'Xuất file';
$lang_module['import_file'] = 'Nhập file vào hệ thống';
$lang_module['choose_file'] = 'Chọn file';
$lang_module['caution'] = 'Lưu ý dạng file tải lên phải là file excel có các đuôi như: xlsx, xls. Trước khi tải import file excel lên hẹ thông bạn phải gửi danh sách các folder/file trong file excel lên Google Driev và đảm bảo đường dẫn của các folder/file là đường dẫn trên internet (có quyền chia sẻ với mọi người)';
